...
import com.example.myapplication.R.id.txt_Total
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val txt_Total = findViewById<EditText>(txt_Total)
        ...
        btn_Converter.setOnClickListener {
            ...
            } else if (txt_Total.text.isEmpty()) {
                txt_Total.error = "Digite a quantidade Total(is)"
            } else {
                val Total: Int = txt_Ano.text.toString().toInt()
